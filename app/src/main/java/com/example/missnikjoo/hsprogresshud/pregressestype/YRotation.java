...
public class YRotation  extends HSBaseView implements Interfaces.HSProgress,Interfaces.HSProgressAnimation {

    public YRotation(Context context, HSProgressModel progress) {
