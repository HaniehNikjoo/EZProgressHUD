...
public class LordOfTheRings  extends HSBaseView implements Interfaces.HSProgress,Interfaces.HSProgressAnimation {

    public LordOfTheRings(Context context, HSProgressModel progress) {
